 ...
 */
export async function loadCoreResources(type: CoreResourceType): Promise<boolean> {
  ...
  const status = await window.ipcRenderer.invoke('main.CoreLoader:loadResource', { path: resourcePath })
