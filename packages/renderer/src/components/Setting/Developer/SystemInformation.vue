        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <NEllipsis>
                {{
                  `${si('cpu.physicalCores')} (${si('cpu.performanceCores')} P-Cores + ${si(
                    'cpu.efficiencyCores'
                  )}
                E-Cores)`
                }}
          ...
          <NTable striped>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <NEllipsis>{{
                    adapter.speed ? `${adapter.speed} Mbit / s` : $t('Common.N/A')
                  }}</NEllipsis>
                </td>
              </tr>
            </tbody>
          ...
          <NTable striped>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <NEllipsis>{{
                    !!memory.clockSpeed ? `${memory.clockSpeed}MHz` : $t('Common.N/A')
                  }}</NEllipsis>
                </td>
              </tr>
              <tr>
