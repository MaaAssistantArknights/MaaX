...
export default {
  ...
  async getAllActivities() {
    return (await import('@common/ArknightsGameData/zh_CN/gamedata/excel/activity_table.json'))
      .default
  },
  async getAllItems() {
  ...
  async getAllOperators() {
    return (await import('@common/ArknightsGameData/zh_CN/gamedata/excel/character_table.json'))
